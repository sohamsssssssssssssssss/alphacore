---- MODULE MpscQueue_TTrace_1785386942 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MpscQueue_TTrace_1785386942.json", _TETrace)
...
\*
\*trace == IODeserialize("MpscQueue_TTrace_1785386942.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG MpscQueue_TTrace_1785386942 ----
CONSTANTS
    Capacity = 4
    MaxItem = 3
