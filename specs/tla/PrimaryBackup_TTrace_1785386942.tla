---- MODULE PrimaryBackup_TTrace_1785386942 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("PrimaryBackup_TTrace_1785386942.json", _TETrace)
...
\*
\*trace == IODeserialize("PrimaryBackup_TTrace_1785386942.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([committed |-> {},n2_journal_seq |-> 0,n2_state |-> "BACKUP",n2_epoch |-> 0,n2_hb_count |-> 0,hb_alive |-> TRUE,n1_state |-> "UNKNOWN",active_primary_epoch |-> 0,n1_journal_seq |-> 0,network |-> {},n1_epoch |-> 0,n1_hb_count |-> 0]),
    ([committed |-> {},n2_journal_seq |-> 0,n2_state |-> "BACKUP",n2_epoch |-> 0,n2_hb_count |-> 1,hb_alive |-> TRUE,n1_state |-> "UNKNOWN",active_primary_epoch |-> 0,n1_journal_seq |-> 0,network |-> {},n1_epoch |-> 0,n1_hb_count |-> 0]),
    ([committed |-> {},n2_journal_seq |-> 0,n2_state |-> "BACKUP",n2_epoch |-> 0,n2_hb_count |-> 2,hb_alive |-> TRUE,n1_state |-> "UNKNOWN",active_primary_epoch |-> 0,n1_journal_seq |-> 0,network |-> {},n1_epoch |-> 0,n1_hb_count |-> 0]),
    ([committed |-> {},n2_journal_seq |-> 0,n2_state |-> "PRIMARY",n2_epoch |-> 1,n2_hb_count |-> 0,hb_alive |-> TRUE,n1_state |-> "UNKNOWN",active_primary_epoch |-> 1,n1_journal_seq |-> 0,network |-> {},n1_epoch |-> 0,n1_hb_count |-> 0]),
    ([committed |-> {},n2_journal_seq |-> 0,n2_state |-> "PRIMARY",n2_epoch |-> 1,n2_hb_count |-> 0,hb_alive |-> TRUE,n1_state |-> "PRIMARY",active_primary_epoch |-> 1,n1_journal_seq |-> 0,network |-> {},n1_epoch |-> 1,n1_hb_count |-> 0])
    >>
----
...
---- CONFIG PrimaryBackup_TTrace_1785386942 ----
CONSTANTS
    MaxEntries = 3
    HeartbeatTimeout = 2
    MaxMessages = 5
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 30 10:19:02 IST 2026