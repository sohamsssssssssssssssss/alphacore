---- MODULE MpscQueue_TTrace_1785386913 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MpscQueue_TTrace_1785386913.json", _TETrace)
...
\*
\*trace == IODeserialize("MpscQueue_TTrace_1785386913.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([val |-> 0,write_ticket |-> 0,cseq |-> ,slots |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),consumer_out |-> <<>>,pc |-> <<"Choose", "Choose", "Consume">>,seq_array |-> (0 :> 0 @@ 1 :> 1 @@ 2 :> 2 @@ 3 :> 3),read_ticket |-> 0,cpos |-> 0,p_var |-> <<0, 0>>])
    >>
----
...
---- CONFIG MpscQueue_TTrace_1785386913 ----
CONSTANTS
    Capacity = 4
    MaxItem = 3
