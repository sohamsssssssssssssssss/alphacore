---- MODULE MpscQueue_TTrace_1785388138 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MpscQueue_TTrace_1785388138.json", _TETrace)
...
\*
\*trace == IODeserialize("MpscQueue_TTrace_1785388138.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG MpscQueue_TTrace_1785388138 ----
CONSTANTS
    Capacity = 4
    MaxItem = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 30 10:38:58 IST 2026