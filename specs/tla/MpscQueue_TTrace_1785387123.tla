---- MODULE MpscQueue_TTrace_1785387123 ----
...
_inv ==
    ~(
        ...
        cseq = (1)
        /\
        slots = ((0 :> 4 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0))
        /\
        consumer_out = (<<4>>)
        /\
        pc = (<<"Choose", "Choose", "Consume">>)
        /\
        seq_array = ((0 :> 4 @@ 1 :> 1 @@ 2 :> 2 @@ 3 :> 3))
        /\
        read_ticket = (1)
        /\
        cpos = (0)
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MpscQueue_TTrace_1785387123.json", _TETrace)
...
\*
\*trace == IODeserialize("MpscQueue_TTrace_1785387123.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([val |-> 0,write_ticket |-> 0,cseq |-> 0,slots |-> (0 :> 0 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),consumer_out |-> <<>>,pc |-> <<"Choose", "Claim", "Consume">>,seq_array |-> (0 :> 0 @@ 1 :> 1 @@ 2 :> 2 @@ 3 :> 3),read_ticket |-> 0,cpos |-> 0,p_var |-> <<0, 4>>]),
    ([val |-> 0,write_ticket |-> 1,cseq |-> 0,slots |-> (0 :> 4 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),consumer_out |-> <<>>,pc |-> <<"Choose", "Choose", "Consume">>,seq_array |-> (0 :> 1 @@ 1 :> 1 @@ 2 :> 2 @@ 3 :> 3),read_ticket |-> 0,cpos |-> 0,p_var |-> <<0, 4>>]),
    ([val |-> 4,write_ticket |-> 1,cseq |-> 1,slots |-> (0 :> 4 @@ 1 :> 0 @@ 2 :> 0 @@ 3 :> 0),consumer_out |-> <<4>>,pc |-> <<"Choose", "Choose", "Consume">>,seq_array |-> (0 :> 4 @@ 1 :> 1 @@ 2 :> 2 @@ 3 :> 3),read_ticket |-> 1,cpos |-> 0,p_var |-> <<0, 4>>])
    >>
----
...
---- CONFIG MpscQueue_TTrace_1785387123 ----
CONSTANTS
    Capacity = 4
    MaxItem = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Jul 30 10:22:04 IST 2026